...
,
  {id:11,name:"Quiche Lorraine",cat:"French",time:"40–60 min",source:"other",sourceLabel:"Marmiton",ingr:["1 pâte brisée ou feuilletée (moule 24cm)","200g lardons fumés","4 œufs","25cl crème fraîche épaisse","15cl lait","150g gruyère râpé","Sel, poivre, muscade"],steps:["Préchauffer le four à 180°C (th.6)","Foncer le moule avec la pâte, piquer le fond à la fourchette","Faire revenir les lardons à la poêle sans matière grasse, égoutter","Battre les œufs avec la crème et le lait","Ajouter le gruyère râpé, sel, poivre et muscade","Répartir les lardons sur le fond de tarte","Verser l'appareil œufs-crème par-dessus","Cuire 35–40 min jusqu'à ce que la quiche soit dorée et légèrement gonflée","Laisser tiédir avant de démouler. Servir chaud ou tiède avec une salade verte"],note:"La vraie quiche lorraine traditionnelle ne contient pas de fromage — mais le gruyère la rend encore plus gourmande !"}
];
